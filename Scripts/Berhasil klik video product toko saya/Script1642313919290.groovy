...
WebUI.click(findTestObject('Object Repository/Page_Masuk Sebagai Reseller Evermos/input'))
...
WebUI.click(findTestObject('Object Repository/Page_Toko Saya/a_KOMISI 19_productItem__image'))

WebUI.click(findTestObject('Object Repository/Page_Evermos/a'))

WebUI.click(findTestObject('Object Repository/Page_Evermos/button_Tap to unmute_ytp-large-play-button ytp-button'))
